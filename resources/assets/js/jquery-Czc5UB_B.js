import { c as Fr } from "./_commonjsHelpers-BosuxZz1.js";
var Mt = {
    exports: {}
};
/*!
        ...
        function (qn) {
            (function (j, Je) {
                ...
                i.fn = i.prototype = {
                    ...
                    i.extend({
                        ...
                        isPlainObject: function (e) {
                            var t, n;
                            return !e || _t.call(e) !== "[object Object]" ? !1 : (t = Rt(e),
                                t ? (n = Ie.call(t, "constructor") && t.constructor,
                                    typeof n == "function" && Wt.call(n) === Ln) : !0)
                        },
                ...
                (function () {
                            ...
                            if (!V[s + " "] && (!d || !d.test(s))) {
                                if (A = s,
                                    ...
                                    for (N = jt.test(s) && qt(l.parentNode) || l,
                                        (N != l || !q.scope) && ((w = l.getAttribute("id")) ? w = i.escapeSelector(w) : l.setAttribute("id", w = b)),
                                        O = Ye(s),
                                        m = O.length; m--;)
                                ...
                                try {
                                    return u.apply(p, N.querySelectorAll(A)),
                                        p
                                } catch {
                                    V(s, !0)
                                } finally {
                    ...
                    function Dn(s) {
                        return function (l) {
                            return "form" in l ? l.parentNode && l.disabled === !1 ? "label" in l ? "label" in l.parentNode ? l.parentNode.disabled === s : l.disabled === s : l.isDisabled === s || l.isDisabled !== !s && Pr(l) === s : l.disabled === s : "label" in l ? l.disabled === s : !1
                        }
                    }
                    function Ee(s) {
                    ...
                    function me(s) {
                        ...
                        return p == a || p.nodeType !== 9 || !p.documentElement || (a = p,
                            ...
                            c.msMatchesSelector && pe != a && (l = a.defaultView) && l.top !== l && l.addEventListener("unload", Or),
                            ...
                            Me(function (g) {
                                var v;
                                c.appendChild(g).innerHTML = "<a id='" + b + "' href='' disabled='disabled'></a><select id='" + b + "-\r\\' disabled='disabled'><option selected=''></option></select>",
                                    g.querySelectorAll("[selected]").length || d.push("\\[" + W + "*(?:value|" + ae + ")"),
                                    g.querySelectorAll("[id~=" + b + "-]").length || d.push("~="),
                                    g.querySelectorAll("a#" + b + "+*").length || d.push(".#.+[+~]"),
                                    ...
                                    v.setAttribute("name", ""),
                                    g.appendChild(v),
                                    g.querySelectorAll("[name='']").length || d.push("\\[" + W + "*name" + W + "*=" + W + `*(?:''|"")`)
                            }),
                            q.cssHas || d.push(":has"),
                        ...
                        t = i.expr = {
                            ...
                            filter: {
                                            ...
                                            if (ne) {
                                                ...
                                                if (K = [T ? ne.firstChild : ne.lastChild],
                                                    ...
                                                    for (P = ne[b] || (ne[b] = {}),
                                                        ...
                                                        F = N[0] === h && N[1],
                                                        G = F && N[2],
                                                        E = F && ne.childNodes[F]; E = ++F && E && E[X] || (G = F = 0) || K.pop();)
                                                        if (E.nodeType === 1 && ++G && E === C) {
                                                            P[s] = [h, F, G];
                                                            break
                                                        }
                                                } else if (Re && (P = C[b] || (C[b] = {}),
                                                    N = P[s] || [],
                                                    F = N[0] === h && N[1],
                                                    G = F),
                                                    G === !1)
                                                    for (; (E = ++F && E && E[X] || (G = F = 0) || K.pop()) && !((w ? $(E, le) : E.nodeType === 1) && ++G && (Re && (P = E[b] || (E[b] = {}),
                                                        P[s] = [h, G]),
                                                        E === C));)
                                                        ;
                                                return G -= v,
                                ...
                                PSEUDO: function (s, l) {
                                    ...
                                    return g[b] ? g(l) : g.length > 1 ? (p = [s, s, "", l],
                    ...
                    for (e in {
                        ...
                        t.pseudos[e] = Ir(e);
                    function Nn() { }
                    Nn.prototype = t.filters = t.pseudos,
                        t.setFilters = new Nn;
                    function Ye(s, l) {
                    ...
                    function Ht(s, l, p, g, v, m) {
                        return g && !g[b] && (g = Ht(g)),
                            v && !v[b] && (v = Ht(v, m)),
                            ie(function (T, w, C, O) {
                                var A, N, P, E, F = [], K = [], X = w.length, ne = T || _r(l || "*", C.nodeType ? [C] : C, []), le = s && (T || !l) ? ct(ne, F, s, C, O) : ne;
                                if (p ? (E = v || (T ? s : X || g) ? [] : w,
                                    p(le, E, C, O)) : E = le,
                                    g)
                                    for (A = ct(E, K),
                            ...
                            if (p = t.relative[s[w].type])
                                ...
                                if (p = t.filter[s[w].type].apply(null, s[w].matches),
                                    ...
                                    for (g = ++w; g < v && !t.relative[s[g].type]; g++)
                                        ;
                                    return Ht(w > 1 && Lt(A), w > 1 && st(s.slice(0, w - 1).concat({
                                        value: s[w - 2].type === " " ? "*" : ""
                    ...
                    function Wr(s, l) {
                        var p = l.length > 0
                            ...
                            , v = function (m, T, w, C, O) {
                                var A, N, P, E = 0, F = "0", K = m && [], X = [], ne = n, le = m || g && t.find.TAG("*", O), Re = h += ne == null ? 1 : Math.random() || .1, G = le.length;
                                for (O && (n = T == a || T || O); F !== G && (A = le[F]) != null; F++) {
                                    if (g && A) {
                                        for (N = 0,
                                            !T && A.ownerDocument != a && (me(A),
                                                w = !f); P = s[N++];)
                                            if (P(A, T || a, w)) {
                                                u.call(C, A);
                                                break
                    ...
                    function kn(s, l, p, g) {
                        ...
                        return (O || Pt(s, A))(g, l, !f, p, !l || jt.test(s) && qt(l.parentNode) || l),
                            p
                    }
                ...
                i.filter = function (e, t, n) {
                    ...
                    i.fn.extend({
                        ...
                        is: function (e) {
                            return !!pt(this, typeof e == "string" && zt.test(e) ? i(e) : e || [], !1).length
                        }
                    });
                var Vt, Wn = /^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]+))$/, Fn = i.fn.init = function (e, t, n) {
                    ...
                    if (n = n || Vt,
                        typeof e == "string")
                        if (e[0] === "<" && e[e.length - 1] === ">" && e.length >= 3 ? r = [null, e, null] : r = Wn.exec(e),
                            r && (r[1] || !t))
                            if (r[1]) {
                ...
                i.each({
                    ...
                    contents: function (e) {
                        return e.contentDocument != null && Rt(e.contentDocument) ? e.contentDocument : ($(e, "template") && (e = e.content || e),
                    ...
                    i.fn[e] = function (n, r) {
                        ...
                        return e.slice(-5) !== "Until" && (r = n),
                            ...
                            this.length > 1 && (Bn[e] || i.uniqueSort(o),
                                $n.test(e) && o.reverse()),
                            this.pushStack(o)
                    }
                });
                ...
                i.extend({
                                                ...
                                                , H = function () {
                                                    ...
                                                    if (!(y < f)) {
                                                        ...
                                                        ae = z && (typeof z == "object" || typeof z == "function") && z.then,
                                                            L(ae) ? x ? ae.call(z, d(f, b, ke, x), d(f, b, et, x)) : (f++,
                                                                ae.call(z, d(f, b, ke, x), d(f, b, et, x), d(f, b, ke, b.notifyWith))) : (h !== ke && (D = void 0,
                                                                    R = [z]),
                                                                    (x || b.resolveWith)(D, R))
                                                    }
                                                }
                    ...
                    when: function (e) {
                        ...
                        if (t <= 1 && (Gt(e, u.done(a(n)).resolve, u.reject, !t),
                ...
                i.Deferred.exceptionHook = function (e, t) {
                    j.console && j.console.warn && e && Un.test(e.name) && j.console.warn("jQuery.Deferred exception: " + e.message, e.stack, t)
                }
                    ,
                ...
                function Qt(e, t, n) {
                    ...
                    if (n === void 0 && e.nodeType === 1)
                        if (r = "data-" + t.replace(Yn, "-$&").toLowerCase(),
                            n = e.getAttribute(r),
                            typeof n == "string") {
                            try {
                                n = Jn(n)
                        ...
                        r = e[u],
                            r.style && (n = r.style.display,
                                t ? (n === "none" && (o[u] = S.get(r, "display") || null,
                                    o[u] || (r.style.display = "")),
                                    r.style.display === "" && nt(r) && (o[u] = Zn(r))) : n !== "none" && (o[u] = "none",
                                        S.set(r, "display", n)));
                    for (u = 0; u < a; u++)
                    ...
                    for (var u, a, c, f, d, y, b = t.createDocumentFragment(), h = [], x = 0, D = e.length; x < D; x++)
                        if (u = e[x],
                            ...
                            if (De(u) === "object")
                                ...
                                for (a = a || b.appendChild(t.createElement("div")),
                            ...
                            for (n.handler && (u = n,
                                ...
                                c = nn.exec(t[d]) || [],
                                    ...
                                    x && (b = i.event.special[x] || {},
                                        ...
                                        (h = f[x]) || (h = f[x] = [],
                                            h.delegateCount = 0,
                                            (!b.setup || b.setup.call(e, r, D, a) === !1) && e.addEventListener && e.addEventListener(x, a)),
                                        b.add && (b.add.call(e, y),
                    ...
                    remove: function (e, t, n, r, o) {
                        ...
                        if (!(!H || !(f = H.events))) {
                            for (t = (t || "").match(oe) || [""],
                                ...
                                for (b = i.event.special[x] || {},
                                    x = (r ? b.delegateType : b.bindType) || x,
                                    h = f[x] || [],
                                    c = c[2] && new RegExp("(^|\\.)" + D.join("\\.(?:.*\\.|)") + "(\\.|$)"),
                                    a = u = h.length; u--;)
                                    y = h[u],
                                ...
                                a && !h.length && ((!b.teardown || b.teardown.call(e, D, H.handle) === !1) && i.removeEvent(e, x, H.handle),
                                    delete f[x])
                            }
                ...
                function Oe(e, t, n, r) {
                    ...
                    if (D || b > 1 && typeof x == "string" && !q.checkClone && nr.test(x))
                        return e.each(function (R) {
                            var H = e.eq(R);
                            D && (t[0] = x.call(this, R, H.html())),
                                Oe(H, t, n, r)
                        });
                    if (b && (o = tn(t, e[0].ownerDocument, !1, e, r),
                        u = o.firstChild,
                        o.childNodes.length === 1 && (o = u),
                        u || r)) {
                        for (a = i.map(Y(o, "script"), ir),
                            c = a.length; y < b; y++)
                            f = o,
                                y !== h && (f = i.clone(f, !0, !0),
                        ...
                        if (c)
                            for (d = a[a.length - 1].ownerDocument,
                                ...
                                y = 0; y < c; y++)
                                f = a[y],
                                    en.test(f.type || "") && !S.access(f, "globalEval") && i.contains(d, f) && (f.src && (f.type || "").toLowerCase() !== "module" ? i._evalUrl && !f.noModule && i._evalUrl(f.src, {
                        ...
                        i.extend(q, {
                            ...
                            reliableTrDimensions: function () {
                                ...
                                return a == null && (y = k.createElement("table"),
                                    ...
                                    Te.appendChild(y).appendChild(b).appendChild(h),
                                    x = j.getComputedStyle(b),
                                    a = parseInt(x.height, 10) + parseInt(x.borderTopWidth, 10) + parseInt(x.borderBottomWidth, 10) === b.offsetHeight,
                                    Te.removeChild(y)),
                                    a
                            }
                        }))
                ...
                function ze(e, t, n) {
                    ...
                    return n = n || it(e),
                        n && (a = n.getPropertyValue(t) || n[t],
                            ...
                            !q.pixelBoxStyles() && vt.test(a) && ar.test(t) && (r = f.width,
                                o = f.minWidth,
                                u = f.maxWidth,
                ...
                i.extend({
                    ...
                    style: function (e, t, n, r) {
                        if (!(!e || e.nodeType === 3 || e.nodeType === 8 || !e.style)) {
                            ...
                            if (f || (t = xt(c)),
                                ...
                                n !== void 0) {
                                if (u = typeof n,
                                    u === "string" && (o = $e.exec(n)) && o[1] && (n = Jt(e, t, o),
                                        u = "number"),
                                    n == null || n !== n)
                                    return;
                    ...
                    i.each(["height", "width"], function (e, t) {
                        i.cssHooks[t] = {
                            get: function (n, r, o) {
                                if (r)
                                    return fr.test(i.css(n, "display")) && (!n.getClientRects().length || !n.getBoundingClientRect().width) ? an(n, cr, function () {
                                        return hn(n, t, o)
                                    }) : hn(n, t, o)
                            },
                            set: function (n, r, o) {
                    ...
                    i.cssHooks.marginLeft = sn(q.reliableMarginLeft, function (e, t) {
                        if (t)
                            return (parseFloat(ze(e, "marginLeft")) || e.getBoundingClientRect().left - an(e, {
                                marginLeft: 0
                            }, function () {
                ...
                function pr(e, t, n) {
                    ...
                    if (f = !i.isEmptyObject(t),
                        !(!f && i.isEmptyObject(x))) {
                        b && e.nodeType === 1 && (n.overflow = [D.overflow, D.overflowX, D.overflowY],
                            d = H && H.display,
                ...
                function re(e, t, n) {
                    var r, o, u = 0, a = re.prefilters.length, c = i.Deferred().always(function () {
                        ...
                        for (var b = Pe || gn(), h = Math.max(0, d.startTime + d.duration - b), x = h / d.duration || 0, D = 1 - x, R = 0, H = d.tweens.length; R < H; R++)
                            d.tweens[R].run(D);
                        return c.notifyWith(e, [d, D, h]),
                            D < 1 && H ? h : (H || c.notifyWith(e, [d, 1, 0]),
                                c.resolveWith(e, [d]),
                                !1)
                    }, d = c.promise({
                        elem: e,
                        ...
                        createTween: function (b, h) {
                            var x = i.Tween(e, d.opts, b, h, d.opts.specialEasing[b] || d.opts.easing);
                            return d.tweens.push(x),
                                x
                        },
                        stop: function (b) {
                            var h = 0
                            ...
                            for (o = !0; h < x; h++)
                                d.tweens[h].run(1);
                            return b ? (c.notifyWith(e, [d, 1, 0]),
                                c.resolveWith(e, [d, b])) : c.rejectWith(e, [d, b]),
                                this
                        }
                    }), y = d.props;
                        ...
                        attr: function (e, t, n) {
                            ...
                            if (!(u === 3 || u === 8 || u === 2)) {
                                if (typeof e.getAttribute > "u")
                                    return i.prop(e, t, n);
                                if ((u !== 1 || !i.isXMLDoc(e)) && (o = i.attrHooks[t.toLowerCase()] || (i.expr.match.bool.test(t) ? vn : void 0)),
                                    n !== void 0) {
                                    if (n === null) {
                                        i.removeAttr(e, t);
                                        return
                        ...
                        return arguments.length ? (r = L(e),
                            this.each(function (u) {
                                ...
                                t && "get" in t && (n = t.get(o, "value")) !== void 0 ? n : (n = o.value,
                                    typeof n == "string" ? n.replace(vr, "") : n ?? "")) : void 0
                    }
                }),
                    i.extend({
                        valHooks: {
...
`) : e)),
                ...
                i.extend(i.event, {
                    trigger: function (e, t, n, r) {
                        ...
                        if (u = b = a = n = n || k,
                            !(n.nodeType === 3 || n.nodeType === 8) && !xn.test(x + i.event.triggered) && (x.indexOf(".") > -1 && (D = x.split("."),
                                x = D.shift(),
                                D.sort()),
                                f = x.indexOf(":") < 0 && "on" + x,
                            ...
                            if (!r && !y.noBubble && !Ae(n)) {
                                for (c = y.delegateType || x,
                                    xn.test(c + x) || (u = u.parentNode); u; u = u.parentNode)
                                    h.push(u),
                                        a = u;
                            ...
                            for (o = 0; (u = h[o++]) && !e.isPropagationStopped();)
                                b = u,
                                    ...
                                    d && d.apply(u, t),
                                    d = f && u[f],
                                    d && d.apply && We(u) && (e.result = d.apply(u, t),
                                        e.result === !1 && e.preventDefault());
                            return e.type = x,
                                !r && !e.isDefaultPrevented() && (!y._default || y._default.apply(h.pop(), t) === !1) && We(n) && f && L(n[x]) && !Ae(n) && (a = n[f],
                                    a && (n[f] = null),
                                    i.event.triggered = x,
                ...
                function St(e, t, n, r) {
                    ...
                    if (Array.isArray(t))
                        i.each(t, function (u, a) {
                            n || br.test(e) ? r(e, a) : St(e + "[" + (typeof a == "object" && a != null ? u : "") + "]", a, n, r)
                        });
                        ...
                        serializeArray: function () {
                            return this.map(function () {
                                ...
                                return n == null ? null : Array.isArray(n) ? i.map(n, function (r) {
                                    return {
                                        name: t.name,
                                        value: r.replace(Tn, `\r
`)
                                    }
                                }) : {
                                    name: t.name,
                                    value: n.replace(Tn, `\r
`)
                                }
                            }).get()
                        }
                ...
                i.extend({
                    ...
                    ajaxSetup: function (e, t) {
                        return t ? Dt(Dt(e, i.ajaxSettings), t) : Dt(i.ajaxSettings, e)
                    },
                    ajaxPrefilter: Sn(Cn),
                    ajaxTransport: Sn(Et),
                    ajax: function (e, t) {
                        ...
                        if (R.promise(M),
                            ...
                            try {
                                c.href = h.url,
                                    c.href = c.href,
                                    h.crossDomain = At.protocol + "//" + At.host != c.protocol + "//" + c.host
                            } catch {
                                h.crossDomain = !0
                            }
                        }
                        ...
                        d = i.event && h.global,
                            ...
                            r = h.url.replace(Cr, ""),
                            h.hasContent ? h.data && h.processData && (h.contentType || "").indexOf("application/x-www-form-urlencoded") === 0 && (h.data = h.data.replace(Tr, "+")) : (b = h.url.slice(r.length),
                                h.data && (h.processData || typeof h.data == "string") && (r += (wt.test(r) ? "&" : "?") + h.data,
                                    delete h.data),
                                h.cache === !1 && (r = r.replace(wr, "$1"),
                                    b = (wt.test(r) ? "&" : "?") + "_=" + bn.guid++ + b),
                                h.url = r + b),
                            ...
                            M.setRequestHeader("Accept", h.dataTypes[0] && h.accepts[h.dataTypes[0]] ? h.accepts[h.dataTypes[0]] + (h.dataTypes[0] !== "*" ? ", " + wn + "; q=0.01" : "") : h.accepts["*"]);
                        for (y in h.headers)
                        ...
                        function Se(I, B, Ge, kt) {
                            ...
                            f || (f = !0,
                                ...
                                be = kr(h, be, M, fe),
                                fe ? (h.ifModified && (xe = M.getResponseHeader("Last-Modified"),
                                    xe && (i.lastModified[r] = xe),
                                    xe = M.getResponseHeader("etag"),
                                    xe && (i.etag[r] = xe)),
                                    I === 204 || h.type === "HEAD" ? te = "nocontent" : I === 304 ? te = "notmodified" : (te = be.state,
                                        Qe = be.data,
                                        ce = be.error,
                                        fe = !ce)) : (ce = te,
                                            (I || !te) && (te = "error",
                                ...
                                M.status = I,
                                M.statusText = (B || te) + "",
                                fe ? R.resolveWith(x, [Qe, te, M]) : R.rejectWith(x, [M, te, ce]),
                                M.statusCode(V),
                                V = void 0,
                                d && D.trigger(fe ? "ajaxSuccess" : "ajaxError", [M, h, fe ? Qe : ce]),
                                H.fireWith(x, [M, te]),
                                d && (D.trigger("ajaxComplete", [M, h]),
                                    ...
                                    t = function (c) {
                                        return function () {
                                            t && (t = n = a.onload = a.onerror = a.onabort = a.ontimeout = a.onreadystatechange = null,
                                                c === "abort" ? a.abort() : c === "error" ? typeof a.status != "number" ? o(0, "error") : o(a.status, a.statusText) : o(jr[a.status] || a.status, a.statusText, (a.responseType || "text") !== "text" || typeof a.responseText != "string" ? {
                                                    binary: a.response
                                                } : {
                                                    text: a.responseText
                ...
                i.ajaxSetup({
                    ...
                    i.parseHTML = function (e, t, n) {
                        ...
                        return t || (q.createHTMLDocument ? (t = k.implementation.createHTMLDocument(""),
                            ...
                            o = Ut.exec(e),
                            u = !n && [],
                            o ? [t.createElement(o[1])] : (o = tn([e], t, u),
                    ...
                    i.each({
                        ...
                        i.fn[e] = function (r) {
                            return he(this, function (o, u, a) {
                                var c;
                                if (Ae(o) ? c = o : o.nodeType === 9 && (c = o.defaultView),
                                    a === void 0)
                                    return c ? c[t] : o[u];
                        ...
                        i.each({
                            ...
                            i.fn[r] = function (o, u) {
                                ...
                                return he(this, function (f, d, y) {
                                    var b;
                                    return Ae(f) ? r.indexOf("outer") === 0 ? f["inner" + e] : f.document.documentElement["client" + e] : f.nodeType === 9 ? (b = f.documentElement,
                                        Math.max(f.body["scroll" + e], b["scroll" + e], f.body["offset" + e], b["offset" + e], b["client" + e])) : y === void 0 ? i.css(f, d, c) : i.style(f, d, y, c)
                                }, t, a ? o : void 0, a)
                            }
                        })
                    }),
